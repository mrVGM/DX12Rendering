...
rendering::DXDisplaySMMaterial::~DXDisplaySMMaterial()
{
}

ID3D12CommandList* rendering::DXDisplaySMMaterial::GenerateCommandList(
...
void rendering::DXDisplaySMMaterial::CreatePipelineStateAndRootSignature()
{
...
void rendering::DXDisplaySMMaterial::CreateDescriptorHeaps()
{
    {
