...
namespace rendering
{
	...
	class DXShadowMaskFilterMaterial : public rendering::DXMaterial
	{
	private:
	...
	public:
		DXShadowMaskFilterMaterial(const DXShader& vertexShader, const DXShader& pixelShader, int renderTargetTex);
		virtual ~DXShadowMaskFilterMaterial();
