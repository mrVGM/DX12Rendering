...
namespace rendering::psm
{
	...
	class DXShadowMaskMaterial : public rendering::DXMaterial
	{
	private:
	...
	public:
		DXShadowMaskMaterial(const DXShader& vertexShader, const DXShader& pixelShader);
		virtual ~DXShadowMaskMaterial();
